...
See the [README](https://github.com/0xTheProDev/setup-js#readme) to get an overview of the project. Here are some helpful resources to get you comfortable with open source contribution:
...
- Take a look at the Existing Issues or visit [Discussions Section](https://github.com/0xTheProDev/setup-js/discussions) to engage into discussion about feature request or bug reporting.
...
```bash
$ git clone https://github.com/<your-username>/setup-js
$ cd setup-js
$ git remote add upstream https://github.com/0xTheProDev/setup-js
$ git fetch upstream
```
